...
int print_binary(va_list types, char buffer[], int flags,
		 int width, int precision, int size);
int print_unsgnd(va_list types, char buffer[], int flags,
		 int width, int precision, int size);
...
/* width handler */
int print_handle_write_char(va_list types, char buffer[], int flags,
		 int width, int precision, int size);
int print_write_number(va_list types, int ind, char buffer[], int flags,
		 int width, int precision, int size);
int print_write_num(int ind, char bff[], int flags,
		 int width, int precision, int length, char padd, char extra_c);
int print_write_pointer(char buffer[], int ind, int length, int flags,
